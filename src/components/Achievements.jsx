...
import { Trophy, Award, ExternalLink, Github, Sparkles, CheckCircle2, ArrowRight } from 'lucide-react';

const Achievements = () => {
  const certificateUrl = "https://drive.google.com/file/d/1h8bpL6baSkEZrc2A6K5ibd9b1l0cBQXp/view?usp=sharing";
  const githubUrl = "https://github.com/Arshan18/NeoAgri.git";
  ...
  return (
    <section id="achievements" className="py-12 sm:py-16 bg-slate-50 border-b border-slate-200 relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] sm:w-[500px] h-[200px] bg-amber-200/30 blur-3xl rounded-full pointer-events-none" />
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-2xl mx-auto space-y-2 mb-8 sm:mb-10">
          ...
          <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 tracking-tight">
            Major Hackathon Achievement
          </h2>
        </div>

        {/* Main Compact Achievement Card */}
        <div className="rounded-3xl bg-slate-900 text-white p-6 sm:p-8 border border-slate-800 shadow-xl space-y-6 text-left relative overflow-hidden">
