...
const SkillsMatrix = () => {
  const getCategoryIcon = (category) => {
    switch (category) {
      case 'Data & Analytics': return <Database className="w-5 h-5 text-blue-600" />;
      case 'Programming': return <Code2 className="w-5 h-5 text-blue-600" />;
      case 'Data Engineering & Cloud': return <Cloud className="w-5 h-5 text-blue-600" />;
      case 'BI & Visualization': return <BarChart3 className="w-5 h-5 text-blue-600" />;
      case 'AI & LLM': return <Bot className="w-5 h-5 text-blue-600" />;
      case 'ML Foundations': return <Cpu className="w-5 h-5 text-blue-600" />;
