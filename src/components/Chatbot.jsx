...
import { Bot, X, Send, Sparkles, RefreshCw, User, ExternalLink } from 'lucide-react';
  ...
  const [messages, setMessages] = useState([
    {
      id: 1,
      sender: 'bot',
      text: "👋 Hi! I'm **Arshan AI**, Arshan's Portfolio Assistant.\n\nAsk me anything about Arshan Attar's experience in **Data Analytics**, **SQL**, **Python**, projects, skills, or contact info!",
    ...
    setMessages([
      {
        id: Date.now(),
        sender: 'bot',
        text: "Conversation cleared! How else can I assist you with Arshan's portfolio?",
        timestamp: new Date().toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })
      }
    ]);
  };
      ...
      <div className="fixed bottom-5 right-5 z-50">
        {!isOpen && (
          <button
            ...
            aria-label="Open Arshan AI Chatbot"
          >
            ...
            <span className="font-extrabold text-sm sm:text-base tracking-wide">Ask Arshan AI</span>
          </button>
        )}
      </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                <div className="flex items-center gap-1.5">
                  <h3 className="font-extrabold text-white text-base leading-tight">Arshan AI</h3>
                  <span className="px-2 py-0.5 rounded-full text-[10px] font-mono font-bold bg-cyan-500/20 text-cyan-300 border border-cyan-500/30">
                    Assistant
                  </span>
                </div>
                <p className="text-xs text-slate-400">Ask about Arshan's experience & projects</p>
              </div>
            </div>
          ...
          <div className="p-3 bg-slate-800/90 border-t border-slate-700">
            ...
            >
              <input
                ...
                placeholder="Ask Arshan AI a question..."
